...
```G1ANT
timeout.reset value ⟦integer⟧
```

## Description

This command resets the global timeout.

| Name | Type | Required | Default Value | Description |
| -------- | ---- | -------- | ------------- | ----------- |
|`value`| [integer](https://manual.g1ant.com/link/G1ANT.Language/G1ANT.Language/Structures/IntegerStructure.md) | yes | | Time in seconds for the new timeout value |
