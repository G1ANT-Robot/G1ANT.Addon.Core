...
> **Note:** The `excel.open`, `ie.open` and `selenium.open` commands require the MSOffice, IExplorer and Selenium addons enabled, respectively. You can do that in the Addons [panel](https://manual.g1ant.com/link/G1ANT.Manual/g1ant.robot-window/panels.md).
