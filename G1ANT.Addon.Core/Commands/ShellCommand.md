...
| `timeout`      | [timespan](https://manual.g1ant.com/link/G1ANT.Language/G1ANT.Language/Structures/TimeSpanStructure.md) | no       | [♥timeoutprogram](https://manual.g1ant.com/link/G1ANT.Addon.Core/G1ANT.Addon.Core/Variables/TimeoutProgramVariable.md) | Specifies time in milliseconds for G1ANT.Robot to wait for the command to be executed |
