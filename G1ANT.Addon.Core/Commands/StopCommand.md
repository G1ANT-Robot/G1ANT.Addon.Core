...
| -------- | ---- | -------- | ------------- | ----------- |
|`silentmode`| [bool](https://manual.g1ant.com/link/G1ANT.Language/G1ANT.Language/Structures/BooleanStructure.md) | no | false | If set to `true`, the command silently stops the script without showing errors; `false` value enables displaying errors |
