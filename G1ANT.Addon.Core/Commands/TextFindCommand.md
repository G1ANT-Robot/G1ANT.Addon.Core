...
|`regex`| [text](https://manual.g1ant.com/link/G1ANT.Language/G1ANT.Language/Structures/TextStructure.md) | no |  |[Regular expression](https://manual.g1ant.com/link/G1ANT.Manual/appendices/regex.md) to be used in order to find a text value |
