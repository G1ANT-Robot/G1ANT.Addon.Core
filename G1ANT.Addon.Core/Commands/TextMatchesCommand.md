...
This command gives you a percentage value (0-100) of how much a given text complies with a provided [regex](https://manual.g1ant.com/link/G1ANT.Manual/appendices/regex.md).

| Argument | Type | Required | Default Value | Description |
| -------- | ---- | -------- | ------------- | ----------- |
|`text`| [text](https://manual.g1ant.com/link/G1ANT.Language/G1ANT.Language/Structures/TextStructure.md) | yes |  | Text or a variable with the content to be matched against regex |
|`regexes`| [text](https://manual.g1ant.com/link/G1ANT.Language/G1ANT.Language/Structures/TextStructure.md) | yes |  | Regex to be matched against text input |
